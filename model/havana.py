...
from spektral.layers.convolutional import GATConv, ARMAConv
from keras.layers import Input, Dense, Concatenate, Dropout, Attention
...
class HAVANA:
    ...
    def build(self, seed=None):
        ...
        Location_location_input = Input(
            (self.max_size_matrices, self.max_size_matrices)
        )
        ...
        out_dense = (
            tf.Variable(2.0) * out_location_location
            + tf.Variable(2.0) * out_location_time
        )
        ...
        out_week_temporal2 = GATConv(20, kernel_regularizer=l2_reg)(
            [out_week_temporal2, A_week_input]
        )
        ...
        out_weekend_temporal2 = GATConv(20, kernel_regularizer=l2_reg)(
            [out_weekend_temporal2, A_weekend_input]
        )
        ...
        out_dense2 = (
            tf.Variable(2.0) * out_location_location2
            + tf.Variable(2.0) * out_location_time2
        )
